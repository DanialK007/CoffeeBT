...
if (isset($_POST["create"])) {
    ...
    $targetFile = $targetDirectory . basename($_FILES["product_img"]["name"]);
            ...
            if ($_FILES["product_img"]["size"] > 5000000) {
                ...
                if (!in_array($imageFileType, $allowedExtensions)) {
                    ...
                    if (move_uploaded_file($_FILES["product_img"]["tmp_name"], $targetFile)) {
                        ...
                        $product_img = $targetFile;  // Store this path in your database
                    } else {
    ...
    if (isset($_FILES["product_img"]) && $_FILES["product_img"]["error"] == 0) {
        ...
        // Insert into the database with $product_img (assuming you have modified your table structure to include product_img)
...
<div class="container pt-3">
    ...
    <div class="display-3 pb-3 fw-bold">Product</div>
            ...
            <form action="" method="post" class="modal-content" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h1 class="py-3">Create a New product</h1>
                            <div class="row p-2">
                                <div class="col-4">
                                    <label for="form-label" class="fs-5 pb-2">product Name</label>
                                </div>
                                <div class="col-8">
                                    <input required type="text" name="product_name" class="form-control p-3">
                                </div>
                            </div>
                            <div class="row p-2">
                                <div class="col-4">
                                    <label for="form-label" class="fs-5 pb-2">product price</label>
                                </div>
                                <div class="col-8">
                                    <input required type="text" name="product_price" class="form-control p-3">
                                </div>
                            </div>
                            <div class="row p-2">
                                <div class="col-4">
                                    <label for="product_img" class="fs-5 pb-2">Upload product Image</label>
                                </div>
                                <div class="col-8">
                                    <input required type="file" name="product_img" id="product_img" class="form-control p-3">
                                </div>
                            </div>
                        </div>
                    </div>
